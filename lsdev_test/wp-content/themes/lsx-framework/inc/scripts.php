...
function lsx_scripts() {
	...
	// custom stylesheets
	wp_enqueue_style('lsx_shield', get_template_directory_uri() . '/assets/css/shield.css', false, 'cbb994c13f6a865b6e5acae303eeb1zz');
	...
	wp_enqueue_script( 'customscript', get_template_directory_uri() . '/assets/js/customjs.js', array(), '1.0.0', true );
